		...
		<div class="artifact-base">
			...
			<div class="artifact-base-info">
				...
				<p class="artifact-info">
					...
					<p class="star-list">
						<img v-for="s of data.rank" :key="s" src="/genshin/adachi-assets/resource/rarity/icon/Icon_1_Stars.webp" alt="STAR">
					</p>
				</p>
			</div>
		</div>
...
export default defineComponent( {
	...
	setup( props ) {
		...
		const artifactIcon = computed( () => {
			if ( !data ) return "";
			return `/genshin/adachi-assets/artifact/${ data.shirtName }/image/${ position }.webp`;
		} )
